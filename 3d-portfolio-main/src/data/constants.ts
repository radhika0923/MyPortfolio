...
export const SKILLS: Record<SkillNames, Skill> = {
  ...
  [SkillNames.CPP]: {
    ...
    name: "cpp",
    label: "C++",
    shortDescription: "high-performance programming for core problem solving.",
    color: "#00599c",
  ...
  [SkillNames.JAVA]: {
    ...
    name: "java",
    label: "Java",
    shortDescription: "robust object-oriented programming for scalable applications.",
    color: "#f89820",
...
using use = useUsing("use")`,
  ...
  [SkillNames.VITE]: {
    ...
    name: "vite",
    label: "Vite",
    shortDescription: "lightning-fast frontend tooling and bundling experience.",
    color: "#646cff",
  ...
  [SkillNames.MYSQL]: {
    ...
    name: "mysql",
    label: "MySQL",
    shortDescription: "relational database design and optimized SQL querying.",
    color: "#4479a1",
  ...
  [SkillNames.SPRINGBOOT]: {
    ...
    name: "springboot",
    label: "Spring Boot",
    shortDescription: "building production-ready Java backend services.",
    color: "#6db33f",
  ...
  [SkillNames.DBMS]: {
    ...
    name: "dbms",
    label: "DBMS",
    shortDescription: "database modeling, normalization, and system design fundamentals.",
    color: "#6366f1",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg",
  },
  [SkillNames.DSA]: {
    ...
    shortDescription: "strong foundations in algorithmic thinking and complexity analysis.",
    color: "#f97316",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cplusplus/cplusplus-original.svg",
  },
  [SkillNames.POSTMAN]: {
    ...
    name: "postman",
    label: "Postman",
    shortDescription: "API testing, documentation, and workflow automation.",
    color: "#ff6c37",
...
// Spline keycap object names should match these skill names exactly.
// Keep this list in sync with the visible keyboard keycaps in skills-keyboard.spline.
